...
$tblname = "slider";
$tblkey = "id";
$pagename = "Footer Clients Logo Slider";
...
<div class="container-fluid pt-4 px-4 ">
    ...
    <form action="" method="POST" enctype="multipart/form-data">
        <div class="container-fluid pt-4 px-4 ">
            <h4 class="text-center fw-bolder text-primary">Add <?= $pagename; ?></h4>
            ...
            <div class="row mt-5">
                ...
                <div class="col-lg-6">
                    <div class="form-group shadow ">
                        <div class="form-floating mb-3 ">
                            <input type="file" class="form-control bg-white" id="file_upload" accept="image/png, image/jpeg"  title="Upload Logo height: 100px - width: 150px" placeholder="Upload Logo height: 100px - width: 150px" name="file_upload"
                                required>
...
<div class="container-fluid pt-4 px-4">
    <div class="row">
        <div class="col-sm-12 col-lg-12">
            ...
            <p class="text-center  text-danger m-0 p-0"><small>height: 100px - width: 150px</small></p>
